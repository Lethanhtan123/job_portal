    ...
    <div class="container">
      <div class="row justify-content-between">
        <div class="footer-col-1 col-md-3 col-sm-12">
          ...
          <div class="mt-20 mb-20 font-sm color-text-paragraph-2">joblist is the heart of the design community and the
      ...
      <div class="footer-bottom mt-50">
        <div class="row">
          <div class="col-md-6"><span class="font-sm color-text-paragraph">Copyright &copy; 2024. JOBLIST all right
              reserved</span></div>
          <div class="col-md-6 text-md-end text-start">
            <div class="footer-social"><a class="font-sm color-text-paragraph" href="#">Privacy Policy</a><a
                class="font-sm color-text-paragraph mr-30 ml-30" href="#">Terms &amp; Conditions</a><a
                class="font-sm color-text-paragraph" href="#">Security</a></div>
          </div>
        </div>
      </div>
    </div>
