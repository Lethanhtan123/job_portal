                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="font-sm text-capitalize color-text-mutted mb-10">Company name * </label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="font-sm text-capitalize color-text-mutted mb-10">Logo * </label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="font-sm text-capitalize color-text-mutted mb-10">Company bio * </label>
                                        <textarea name="bio"  class="  {{ $errors->has('bio') ? 'is-invalid' : ''  }}  summernote"></textarea>
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <form action="">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="font-sm text-capitalize color-text-mutted mb-10">Establishment date</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group select-style">
                                        <label class="font-sm text-capitalize color-text-mutted mb-10">Country *</label>
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <label class="font-sm text-capitalize color-text-mutted mb-10">Address *</label>
                                        <input class="form-control" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label class="font-sm text-capitalize color-text-mutted mb-10">Map link </label>
                                        <input class="form-control" type="text" value="">
                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                        <form action="">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group select-style">
                                        <label class="font-sm text-capitalize color-text-mutted mb-10">Unsername * </label>
                                        <input class="form-control" type="text" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="font-sm text-capitalize color-text-mutted mb-10">Password * </label>
                                        <input class="form-control" type="text" value="">
                                    </div>
                                </div>
                                <div class="col-md-6">
