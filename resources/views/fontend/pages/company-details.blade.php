        ...
        <div class="box-company-profile">
            <div class="mt-10 row">
                <div class="col-lg-8 col-md-12">
                    ...
                    <h5 class="f-18">{{ $company->name }} <span class="ml-20 card-location font-regular">{{
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        <div class="card-grid-2-image-left">
                                            ...
                                            <div class="right-info"><a class="name-job"
                                                    ...
                                                    $job->company->name }}</a><span class="location-small">{{
                                                    formatLocation($job->company->companyCountry->name,
                    ...
                    <div class="sidebar-heading">
                        <div class="avatar-sidebar">
                            ...
                            <div class="sidebar-info"><span class="sidebar-company">{{ $company->name }}</span><span
                                    class="mt-1 card-location">{{ formatLocation($company->companyCountry->name)
                                    }}</span>
                                {{-- @if ($openJobs > 0)
