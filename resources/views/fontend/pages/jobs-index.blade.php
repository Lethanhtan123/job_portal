                                        ...
                                        <li>
                                            <label class="cb-container">
                                                <input type="checkbox" name="category[]"
                                                    value="{{ $category->slug }}"><span class="text-small">{{
                                                    $category->name }}</span><span class="checkmark"></span>
                            ...
                            <div class="mb-20 filter-block">
                                ...
                                <div class="pb-20 list-checkbox">
                                    ...
                                    <div class="box-number-money">
                                        <div class="row mt-30">
                                            <div class="col-sm-6 col-6"><span class="font-sm color-brand-1">0 Triệu/VNĐ</span>
                                            </div>
                                        ...
                                        <li>
                                            <label class="cb-container">
                                                <input type="checkbox" name="jobtype[]"
                                                    value="{{ $item->slug }}"><span class="text-small">{{
                                                    $item->name }}</span><span class="checkmark"></span>
                                            </label>
                                        </li>
                                        @endforeach
                                    </ul>
